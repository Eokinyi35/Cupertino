...
class ProductsRepository {
  ...
  Widget _buildBody(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
      stream: Firestore.instance.collection('cupertinostore').snapshots(),
...
//class ProductRepository extends StatefulWidget {
//  @override
//  _ProductRepositoryState createState() => _ProductRepositoryState();
//}
//
//class _ProductRepositoryState extends State<ProductRepository> {
//  @override
